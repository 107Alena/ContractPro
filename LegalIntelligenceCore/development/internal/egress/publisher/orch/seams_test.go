...
// router.TestCallOutcome_WireStringsPinned / cost / schemavalidator /
// dm.TestPublishOutcome_WireStringsPinned. This is the ONLY file in this
// package that imports internal/infra/observability/metrics, and it is a
// _test file, so package hermeticity (asserted by internal_test.go.
// TestHermeticImports over the non-test sources) holds.
