...
// CommandPublisher publishes processing and comparison commands to DP.
...
// and logger.
func NewPublisher(broker BrokerPublisher, topicProcess, topicCompare string, log *logger.Logger) *Publisher {
	return &Publisher{
		broker:       broker,
