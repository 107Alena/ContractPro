...
func TestOpenAIConfig_Validate_HappyPath(t *testing.T) {
	cfg := OpenAIConfig{
		APIKey:  "sk-test",
...
func TestOpenAIConfig_Validate_MissingFieldsAggregate(t *testing.T) {
	cfg := OpenAIConfig{}
	err := cfg.Validate()
	if err == nil {
...
func TestOpenAIConfig_Validate_InvalidScheme(t *testing.T) {
	cfg := OpenAIConfig{
		APIKey:  "sk-test",
...
func TestOpenAIConfig_Validate_MalformedURL(t *testing.T) {
	cfg := OpenAIConfig{
		APIKey:  "sk-test",
		BaseURL: "://not-a-url",
		Model:   "gpt-4.1",
...
func TestOpenAIConfig_Validate_RejectsUserinfoInURL(t *testing.T) {
	cfg := OpenAIConfig{
		APIKey:  "sk-test",
		BaseURL: "https://user:secret@api.openai.com",
		Model:   "gpt-4.1",
	}
	err := cfg.Validate()
...
func TestOpenAIConfig_Validate_WhitespaceOnlyFields(t *testing.T) {
	cfg := OpenAIConfig{
		APIKey:  "   ",
		BaseURL: " ",
		Model:   "\t\n",
