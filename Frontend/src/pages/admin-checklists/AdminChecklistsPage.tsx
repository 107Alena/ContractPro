...
// Дублируется в pages/admin-policies/AdminPoliciesPage.tsx; при FE-TASK-002
  ...
  return (
    ...
    >
      <EmptyState
        ...
        description="Управление чек-листами обязательных условий появится в версии 1.0.1"
      />
    </main>
  );
}
