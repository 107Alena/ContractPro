...
//
// Приветствие по имени (useMe), один основной CTA «Новая проверка договора»
// (ведёт на /contracts/new) и микрокопия. Микрокопия отражает РЕАЛЬНЫЕ
// ограничения продукта (PDF, до 20 МБ — FileDropZone), а не Figma-текст
  ...
  return (
    <Card radius="xl" aria-label="Приветствие" className="flex flex-col gap-4 px-8 py-7">
      ...
      <div className="flex flex-wrap items-center gap-3">
        <Link to="/contracts/new" className={buttonVariants({ variant: 'primary', size: 'lg' })}>
          Новая проверка договора
        </Link>
      </div>
